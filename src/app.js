...
const inventarioSinTrampas = inventario.filter(item => item !== 'trampa') ;
//console.log(inventarioSinTrampas);
inventarioSinTrampas.push('super estrella');
//console.log(inventarioSinTrampas);
let letrasMayus = inventarioSinTrampas.map(item => item.toUpperCase()) ;
//console.log(letrasMayus);
let [primerItem, segundoItem] = letrasMayus ;
